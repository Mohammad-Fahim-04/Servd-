 ...
 */ const maybeGenerateMetadata = ({ file, index, uploadId, enabled, dispatch })=>{
    ...
    dispatch(uploadProgress.setFileMetadataGenerating({
        index,
        uploadId
    }));
    ...
    promise.unwrap().then((results)=>{
        ...
        dispatch(uploadProgress.setFileMetadataResult({
            index,
            uploadId,
...
exports.maybeGenerateMetadata = maybeGenerateMetadata;
exports.uploadApi = uploadApi;
exports.useGenerateAiMetadataMutation = useGenerateAiMetadataMutation;
