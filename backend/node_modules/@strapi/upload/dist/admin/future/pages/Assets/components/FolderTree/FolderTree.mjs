...
import { useFilter, Flex, Typography, Searchbar, Box, Loader, IconButton, Tooltip } from '@strapi/design-system';
...
import { filterFolderTree } from './filterFolderTree.mjs';
 ...
 * -----------------------------------------------------------------------------------------------*/ const TruncatedFolderName = ({ name, isActive })=>{
    ...
    const label = /*#__PURE__*/ jsx(Typography, {
        ref: textRef,
        variant: "omega",
            ...
            /*#__PURE__*/ jsxs(TreeRow, {
                ...
                children: [
                    /*#__PURE__*/ jsx(IconButton, {
                        ...
                        children: /*#__PURE__*/ jsx(RotatingChevron, {
                    ...
                    /*#__PURE__*/ jsx(Box, {
                        ...
                        children: /*#__PURE__*/ jsx(RowButton, {
                            ...
                            "data-folder-id": id,
                            children: /*#__PURE__*/ jsx(TruncatedFolderName, {
                                name: name,
                                isActive: isActive
                            })
                        })
 ...
 */ const FolderTree = ({ currentFolderId, showActiveFolder = true, onSelectFolder })=>{
    ...
    const { nodes: visibleNodes, expandedIds: filterExpandedIds } = useMemo(()=>trimmedFilter ? filterFolderTree(folderStructure, (name)=>contains(name, trimmedFilter)) : {
    ...
    const isExpandedForRender = useCallback((id)=>filterExpandedIds.includes(id) || isExpanded(id), [
        filterExpandedIds,
        isExpanded
    ]);
                    ...
                    /*#__PURE__*/ jsxs(Box, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx(Box, {
                                ...
                                children: visibleNodes.map((node)=>/*#__PURE__*/ jsx(FolderTreeItem, {
                                        node: node,
                                        level: 0,
                                        currentFolderId: currentFolderId,
                                        showActiveFolder: showActiveFolder,
...
export { FolderTree };
//# sourceMappingURL=FolderTree.mjs.map
