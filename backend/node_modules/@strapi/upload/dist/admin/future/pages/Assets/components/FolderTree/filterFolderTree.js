 ...
 * chain intact.
 */ const filterFolderTree = (nodes, matches)=>{
    const expandedIds = [];
    const prune = (candidates)=>candidates.reduce((retained, node)=>{
...
exports.filterFolderTree = filterFolderTree;
//# sourceMappingURL=filterFolderTree.js.map
