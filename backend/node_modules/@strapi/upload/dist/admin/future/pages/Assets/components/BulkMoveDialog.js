 ...
 */ const BulkMoveDialog = ({ open, onClose })=>{
    ...
    const { data: folderStructure = [] } = folders.useGetFolderStructureQuery(undefined, {
        skip: !open
    });
    const { data: currentFolder } = folders.useGetFolderQuery({
        id: currentFolderId
    }, {
        skip: currentFolderId === null
    });
    const [bulkMove, { isLoading: isMoving }] = folders.useBulkMoveMutation();
    ...
    const dragSet = React.useMemo(()=>buildDragSetFromSelection.buildDragSetFromSelection(selectedIds, selectedFolderIds, currentFolderId), [
        selectedIds,
        selectedFolderIds,
        currentFolderId
    ]);
    ...
    const destinationOptions = React.useMemo(()=>flattenFolderStructure.flattenFolderStructure(folderStructure, selectedFolderIds).filter((option)=>canDropItemOnFolder.canDropItemOnFolder({
                items: dragSet,
    ...
    const canMoveToRoot = React.useMemo(()=>canDropItemOnFolder.canDropItemOnFolder({
            items: dragSet,
            targetFolderId: null,
            folderStructure
        }), [
    ...
    const handleMove = async ()=>{
        ...
        try {
            ...
            toggleNotification({
                type: 'danger',
                message: getBulkMoveErrorMessage.getBulkMoveErrorMessage(error, formatMessage({
                ...
                /*#__PURE__*/ jsxRuntime.jsx(designSystem.Modal.Header, {
                    children: /*#__PURE__*/ jsxRuntime.jsx(designSystem.Modal.Title, {
                        children: formatMessage({
                            id: translations.getTranslationKey('list.bulk-actions.move.title'),
                    ...
                    children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Field.Root, {
                        ...
                        children: [
                            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Field.Label, {
                                children: formatMessage({
                                    id: translations.getTranslationKey('list.bulk-actions.move.location'),
                            ...
                            /*#__PURE__*/ jsxRuntime.jsxs(designSystem.SingleSelect, {
                                ...
                                disabled: isMoving,
                                children: [
                                    canMoveToRoot && /*#__PURE__*/ jsxRuntime.jsx(designSystem.SingleSelectOption, {
                                        value: "",
                                        children: rootLabel
                                    }),
                                    destinationOptions.map((option)=>/*#__PURE__*/ jsxRuntime.jsx(designSystem.SingleSelectOption, {
                    ...
                    children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Button, {
                                ...
                                loading: isMoving,
                                children: formatMessage({
                                    id: translations.getTranslationKey('list.bulk-actions.move.submit'),
                                    defaultMessage: 'Move'
                                })
                            })
                        ]
