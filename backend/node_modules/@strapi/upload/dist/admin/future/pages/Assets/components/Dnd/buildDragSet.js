 ...
 */ const locateItem = (item, currentFolderId)=>item.kind === 'file' ? {
        ...item,
 ...
 */ const buildDragSet = (activeData, selectedKeys, currentFolderId)=>{
    if (!selectedKeys || selectedKeys.size === 0) {
        return {
            items: [
                locateItem(activeData, currentFolderId)
            ],
            fromSelection: false
        };
    }
    const activeKey = activeData.kind === 'file' ? selection.assetKey(activeData.id) : selection.folderKey(activeData.id);
...
exports.buildDragSet = buildDragSet;
//# sourceMappingURL=buildDragSet.js.map
