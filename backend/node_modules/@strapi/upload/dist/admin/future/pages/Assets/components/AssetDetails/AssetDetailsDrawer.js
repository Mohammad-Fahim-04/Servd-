...
const DetailField = ({ name, label, required, disabled })=>{
    ...
    const [value, setValue] = React__namespace.useState(fieldValue);
    React__namespace.useEffect(()=>{
        setValue(fieldValue);
    }, [
        fieldValue
...
const AssetDetails = ({ asset, closeDetails })=>{
    ...
    const { canCreate, canUpdate, canDownload, canCopyLink } = useMediaLibraryPermissions.useMediaLibraryPermissions();
                    ...
                    children: ({ modified, isSubmitting, values, resetForm })=>{
                        ...
                        return /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                            children: [
                                ...
                                /*#__PURE__*/ jsxRuntime.jsxs(Drawer.Drawer.ScrollableContent, {
                                    children: [
                                        /*#__PURE__*/ jsxRuntime.jsx(AssetPreview.AssetPreview, {
                                            asset: asset,
                                            actions: isImage && canUpdate ? /*#__PURE__*/ jsxRuntime.jsx(AssetImageActions, {
                                ...
                                (canUpdate || canCopyLink || canDownload) && /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                            gap: 2,
                                            children: [
                                                canUpdate && /*#__PURE__*/ jsxRuntime.jsx(DeleteAssetButton, {}),
                                                canCopyLink && /*#__PURE__*/ jsxRuntime.jsx(CopyLinkButton, {
                                                    asset: asset
                                                }),
                                                canDownload && /*#__PURE__*/ jsxRuntime.jsx(DownloadAssetButton, {
                                                    asset: asset
                                                })
                                            ]
                                        }),
                                        canUpdate && /*#__PURE__*/ jsxRuntime.jsx(designSystem.Button, {
                                            type: "submit",
                                            variant: "default",
