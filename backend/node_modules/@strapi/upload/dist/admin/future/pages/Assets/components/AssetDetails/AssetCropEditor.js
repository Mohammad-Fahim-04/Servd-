...
const AssetCropEditor = ({ asset, isBusy = false, onClose, onApply, onSaveAsCopy, canSaveAsCopy })=>{
    ...
    const activeDragCleanupRef = React__namespace.useRef(null);
    React__namespace.useEffect(()=>{
        return ()=>{
                    ...
                    /*#__PURE__*/ jsxRuntime.jsxs(FooterBar, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                gap: 2,
                                children: [
                                    canSaveAsCopy && /*#__PURE__*/ jsxRuntime.jsx(designSystem.Button, {
                                        variant: "secondary",
