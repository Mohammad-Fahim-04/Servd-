...
import { Flex, Box, IconButton, ScrollArea } from '@strapi/design-system';
...
const DrawerRoot = ({ isVisible, onClose, children })=>/*#__PURE__*/ jsx(Dialog.Root, {
        open: isVisible,
...
const DrawerScrollableContent = ({ children, isContentExpanded = true })=>/*#__PURE__*/ jsx(CollapsibleContent, {
...
const DrawerCloseButton = ({ onClose, label, children })=>{
    ...
    return /*#__PURE__*/ jsx(CloseIconButton, {
        onClick: onClose,
        label: labelMessage,
        variant: "ghost",
        children: children ?? /*#__PURE__*/ jsx(Cross, {})
    });
};
const Drawer = {
    Root: DrawerRoot,
...
export { DRAWER_CLOSE_ANIMATION_MS, Drawer };
