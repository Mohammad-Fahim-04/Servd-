import { type DateField, type DatePreset, type ListFilters, type TypeValue } from '../hooks/useListFilters';
import type { MessageDescriptor } from 'react-intl';
export declare const TYPE_LABELS: Record<TypeValue, MessageDescriptor>;
export declare const PRESET_LABELS: Record<DatePreset, MessageDescriptor>;
export declare const DATE_FIELD_LABELS: Record<DateField, MessageDescriptor>;
/** Every panel of the filter tree shares this fixed width (design). */
export declare const FILTER_PANEL_WIDTH = "24.2rem";
