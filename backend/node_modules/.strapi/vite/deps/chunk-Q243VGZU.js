import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-65NI2HND.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-PAY54OVR.js";
import {
  getStageColorByHex
} from "./chunk-PHYEBYW2.js";
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-JV7FFGCD.js";
import {
...
} from "./chunk-L6TPLLCP.js";
import {
  index
} from "./chunk-R4HX5FAU.js";
import {
...
} from "./chunk-DQJTLZPN.js";
import {
  ASSET_TYPES
} from "./chunk-4TY22IQS.js";
import {
  useConfig
} from "./chunk-THFKAF4F.js";
import {
  useTracking
} from "./chunk-7ROXYVS7.js";
import {
  ASSET_SOURCES,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-2QF2FNO6.js";
import {
  pluginId
} from "./chunk-5QJFIL32.js";
import {
  useDocumentActions
} from "./chunk-RGPYUWCP.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-H3UK4PIV.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
} from "./chunk-JBYTWJZI.js";
import {
  useAIAvailability
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-T4G6LUUO.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-A7TS57CJ.js").then((mod) => ({
...
var PageSize = ({ onChangePageSize, pageSize }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(v, {
    children: [
...
var Pagination = ({ children, activePage, pageCount, label = "pagination" }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(PaginationContext.Provider, {
    ...
    children: (0, import_jsx_runtime3.jsx)(S, {
      tag: "nav",
      "aria-label": label,
      children: (0, import_jsx_runtime3.jsx)(v, {
        tag: "ul",
        gap: 1,
        children
      })
    ...
    children: [
      onSelectAllAsset && (0, import_jsx_runtime6.jsx)(S, {
        ...
        children: (0, import_jsx_runtime6.jsxs)(v, {
          ...
          children: [
            (assetCount > 0 || folderCount > 0 || isFiltering) && (0, import_jsx_runtime6.jsxs)(v, {
              gap: 2,
              wrap: "wrap",
              children: [
                multiple && isGridView && (0, import_jsx_runtime6.jsx)(v, {
                  paddingLeft: 2,
                  paddingRight: 2,
                  background: "neutral0",
                  hasRadius: true,
            ...
            (assetCount > 0 || folderCount > 0 || isSearching) && (0, import_jsx_runtime6.jsxs)(v, {
              marginLeft: "auto",
              shrink: 0,
              gap: 2,
              children: [
      ...
      pagination.pageCount > 0 && (0, import_jsx_runtime6.jsxs)(v, {
        justifyContent: "space-between",
        paddingTop: 4,
        position: "relative",
        zIndex: 1,
...
var SelectedStep = ({ selectedAssets, onSelectAsset, onReorderAsset }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime8.jsxs)(v, {
    direction: "column",
    alignItems: "stretch",
    gap: 4,
    children: [
      (0, import_jsx_runtime8.jsxs)(v, {
        gap: 0,
        direction: "column",
        alignItems: "start",
        children: [
...
var EmptyStateAsset = ({ disabled = false, onClick, onDropAsset }) => {
  ...
  return (0, import_jsx_runtime13.jsxs)(v, {
...
var HeaderStatusMessage = ({ title, subtitle, metadataSubtitle }) => {
  return (0, import_jsx_runtime16.jsxs)(v, {
    direction: "column",
    alignItems: "flex-start",
    paddingLeft: 2,
    children: [
    ...
    children: (0, import_jsx_runtime16.jsxs)(Drawer.Body, {
      ...
      children: [
        ...
        (0, import_jsx_runtime16.jsx)(Drawer.ScrollableContent, {
          ...
          children: (0, import_jsx_runtime16.jsxs)(v, {
            direction: "column",
            alignItems: "stretch",
            gap: 4,
            paddingTop: 4,
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-ZJUI6UFX.js");
    case "./translations/es.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-MTRVNFYO.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-UQYSU6MJ.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-5R5IOGRK.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
      ...
      (0, import_jsx_runtime17.jsxs)(Pd.Content, {
        children: [
          ...
          (0, import_jsx_runtime17.jsx)(Pd.Body, {
            ...
            children: (0, import_jsx_runtime17.jsxs)(v, {
              direction: "column",
              alignItems: "stretch",
              gap: 2,
              children: [
                (0, import_jsx_runtime17.jsx)(v, {
                  justifyContent: "center",
...
var EntryValidationText = ({ status = "draft", validationErrors, action }) => {
  ...
  const getErrorStr = (key, value) => {
    if (typeof value === "string") {
      ...
      return value.map((v2) => getErrorStr(key, v2)).join(" ");
    } else if (typeof value === "object" && !Array.isArray(value)) {
      return Object.entries(value).map(([k, v2]) => getErrorStr(k, v2)).join(" ");
    } else {
      return "";
    }
  };
  if (validationErrors !== null) {
    ...
    return (0, import_jsx_runtime18.jsxs)(v, {
      gap: 2,
      children: [
...
var LocaleOption = ({ isDraftAndPublishEnabled, locale, status, entryExists }) => {
  ...
  return (0, import_jsx_runtime19.jsxs)(v, {
    width: "100%",
    gap: 1,
    justifyContent: "space-between",
    children: [
...
var AITranslationStatusAction = ({ documentId, model, collectionType }) => {
  ...
  return {
    _status: {
      message: (0, import_jsx_runtime19.jsx)(v, {
        height: "100%",
        alignItems: "center",
        "aria-label": formatMessage({
      ...
      tooltip: (0, import_jsx_runtime19.jsxs)(v, {
        direction: "column",
        padding: 4,
        alignItems: "flex-start",
        width: "25rem",
      ...
      content: ({ onClose }) => (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, {
        children: [
          (0, import_jsx_runtime19.jsx)(Pd.Body, {
            children: (0, import_jsx_runtime19.jsxs)(v, {
              direction: "column",
              gap: 3,
              children: [
...
var DeleteLocaleAction = ({ document, documentId, model, collectionType }) => {
  ...
  return {
    ...
    dialog: {
      ...
      content: (0, import_jsx_runtime19.jsxs)(v, {
        direction: "column",
        gap: 2,
        children: [
          (0, import_jsx_runtime19.jsx)(Jn, {
  ...
  return (0, import_jsx_runtime23.jsxs)(gd.Root, {
    children: [
      (0, import_jsx_runtime23.jsx)(gd.Trigger, {
        children: (0, import_jsx_runtime23.jsx)(v, {
          minWidth: "100%",
          alignItems: "center",
          justifyContent: "center",
          fontWeight: "regular",
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-QBPR6UZB.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
var AddActionToReleaseModal = ({ contentType, documentId, onInputChange, values }) => {
  ...
  return (0, import_jsx_runtime25.jsxs)(v, {
    direction: "column",
    alignItems: "stretch",
    gap: 2,
    children: [
          ...
          children: ({ values, setFieldValue }) => (0, import_jsx_runtime26.jsxs)(Form, {
            children: [
              (releases == null ? void 0 : releases.length) === 0 ? (0, import_jsx_runtime26.jsx)(NoReleases, {}) : (0, import_jsx_runtime26.jsx)(_d.Body, {
                children: (0, import_jsx_runtime26.jsxs)(v, {
                  direction: "column",
                  alignItems: "stretch",
                  gap: 2,
                  children: [
...
var Panel = ({ model, document, documentId, collectionType }) => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime28.jsx)(v, {
      direction: "column",
      alignItems: "stretch",
      gap: 3,
      width: "100%",
      children: releases == null ? void 0 : releases.map((release) => (0, import_jsx_runtime28.jsxs)(v, {
        direction: "column",
        alignItems: "start",
        borderWidth: "1px",
        borderStyle: "solid",
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-34LQHBOA.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-FNYG4NTQ.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-6HFH3XUS.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-427BTMQO.js").then((mod) => ({
...
var Select = ({ stages, activeWorkflowStage, isLoading, ...props }) => {
  ...
  return (0, import_jsx_runtime30.jsx)(cr, {
    ...
    startIcon: activeWorkflowStage && (0, import_jsx_runtime30.jsx)(v, {
      tag: "span",
      height: 2,
    ...
    customizeContent: () => {
      return (0, import_jsx_runtime30.jsxs)(v, {
        tag: "span",
        justifyContent: "space-between",
        alignItems: "center",
        width: "100%",
    ...
    children: stages.map(({ id, color, name: name2 }) => {
      ...
      return (0, import_jsx_runtime30.jsx)(dr, {
        startIcon: (0, import_jsx_runtime30.jsx)(v, {
          height: 2,
          background: color,
...
var Header = () => {
  ...
  return (0, import_jsx_runtime31.jsxs)(v, {
    gap: 2,
    children: [
...
var Panel2 = () => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime32.jsxs)(v, {
      direction: "column",
      gap: 2,
      alignItems: "stretch",
      width: "100%",
...
var StageFilter = (props) => {
  ...
  return (0, import_jsx_runtime34.jsx)(cr, {
    ...
    customizeContent: () => (0, import_jsx_runtime34.jsxs)(v, {
      tag: "span",
      justifyContent: "space-between",
      alignItems: "center",
      width: "100%",
    ...
    children: ((workflow == null ? void 0 : workflow.stages) ?? []).map(({ id, color, name: name2 }) => {
      ...
      return (0, import_jsx_runtime34.jsx)(dr, {
        startIcon: (0, import_jsx_runtime34.jsx)(v, {
          height: 2,
          background: color,
          borderColor: themeColorName === "neutral0" ? "neutral150" : void 0,
          hasRadius: true,
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-N4YEGNHP.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-MWZQPCK5.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-FAFDXTGR.js").then((mod) => ({
...
//# sourceMappingURL=chunk-Q243VGZU.js.map
