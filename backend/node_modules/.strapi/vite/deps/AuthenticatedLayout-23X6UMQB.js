...
var MainNavIcons = ({ listLinks, mobileLinks, handleClickOnLink }) => {
  ...
  return listLinks.length > 0 ? listLinks.map((link) => {
    ...
    return isDesktop || !isDesktop && linkMobile ? (0, import_jsx_runtime3.jsx)(v, {
      tag: "li",
...
var pipe = (...transformers) => transformers.reduce((a, b) => (v2) => b(a(v2)));
...
var NavUser = ({ initials, showDisplayName = false, children, ...props }) => {
  ...
  return (0, import_jsx_runtime16.jsx)(v, {
    ...props,
  ...
  return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
    children: [
      (0, import_jsx_runtime21.jsx)(BannerBackground, {
        width: "100%",
        justifyContent: "center",
        children: (0, import_jsx_runtime21.jsxs)(v, {
          justifyContent: "center",
          alignItems: "center",
          width: "100%",
          paddingTop: 2,
...
//# sourceMappingURL=AuthenticatedLayout-23X6UMQB.js.map
