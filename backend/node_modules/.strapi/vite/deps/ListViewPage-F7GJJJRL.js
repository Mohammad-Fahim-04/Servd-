...
var FileWrapper = ({ children }) => {
  return (0, import_jsx_runtime3.jsx)(v, {
    tag: "span",
    position: "relative",
    borderRadius: "50%",
    width: "26px",
...
var FieldPicker = ({ headers = [], resetHeaders, setHeaders }) => {
  ...
  return (0, import_jsx_runtime6.jsxs)(v, {
    tag: "fieldset",
    direction: "column",
    alignItems: "stretch",
    gap: 1,
    ...
    children: [
      ...
      (0, import_jsx_runtime6.jsx)(v, {
        direction: "column",
        alignItems: "stretch",
        children: columns.map((header) => {
          const isActive = headers.includes(header.name);
          return (0, import_jsx_runtime6.jsx)(v, {
            wrap: "wrap",
            gap: 2,
...
//# sourceMappingURL=ListViewPage-F7GJJJRL.js.map
