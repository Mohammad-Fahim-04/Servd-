import {
  ...
  HOOKS
} from "./chunk-6IWAYAGU.js";
import {
  useNpsSurveySettings
} from "./chunk-ZUX5W2KD.js";
import {
  require_pick
...
import {
  Login
} from "./chunk-PWVE73HM.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-T6CBNNXD.js";
import {
  ConfigurationProvider
} from "./chunk-PNPOOUPL.js";
import {
  useClipboard
} from "./chunk-TQJUTZU4.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-Q7KS7JEJ.js";
import {
  useGetAiUsageQuery
} from "./chunk-SMDBRE2T.js";
import {
  useEnterprise
} from "./chunk-2C6TZKVY.js";
import {
  _setPrototypeOf
...
} from "./chunk-LBN6XAWL.js";
import {
  Form
} from "./chunk-7KM5BNMW.js";
import {
  Layouts
} from "./chunk-MEJRX2QP.js";
import {
  getByteSize
...
\`\`\`
    ...
    if (isChunkLoadError(error)) {
      return (0, import_jsx_runtime6.jsx)(Vd, {
        height: "100%",
        children: (0, import_jsx_runtime6.jsx)(v, {
          alignItems: "center",
          height: "100%",
          justifyContent: "center",
          paddingLeft: RESPONSIVE_DEFAULT_SPACING,
          paddingRight: RESPONSIVE_DEFAULT_SPACING,
          children: (0, import_jsx_runtime6.jsxs)(v, {
            gap: 7,
            padding: {
              initial: 6,
              small: 7,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-VXSXMNQR.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-KIKXCKER.js");
        return {
        ...
        (0, import_jsx_runtime8.jsxs)(LayoutContent, {
          children: [
            ...
            (0, import_jsx_runtime8.jsx)(Form, {
              ...
              children: (0, import_jsx_runtime8.jsxs)(v, {
                direction: "column",
                alignItems: "stretch",
                gap: 6,
                children: [
    ...
    children: (0, import_jsx_runtime11.jsxs)(LayoutContent, {
      children: [
        ...
        (0, import_jsx_runtime11.jsx)(Form, {
          ...
          children: (0, import_jsx_runtime11.jsxs)(v, {
            direction: "column",
            alignItems: "stretch",
            gap: 6,
            marginTop: 7,
        ...
        (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime11.jsx)(S, {
          paddingTop: 4,
          children: (0, import_jsx_runtime11.jsx)(v, {
            justifyContent: "center",
        ...
        (0, import_jsx_runtime12.jsxs)(LayoutContent, {
          children: [
            ...
            (0, import_jsx_runtime12.jsx)(Form, {
              ...
              children: (0, import_jsx_runtime12.jsxs)(v, {
                direction: "column",
                alignItems: "stretch",
                gap: 6,
                children: [
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await retryDynamicImport(() => import("./Login-KKLXNUUU.js"))).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await retryDynamicImport(() => import("./constants-JCP54SRK.js"))).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-P6KUZPYT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-YITZCDXF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-CAYEL5XT.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-JHZLMXIT.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-5QWB63OP.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-VPD25KAB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-WEUJPWRZ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-ZJGLD566.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-AKS4WTKS.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-FNU5LIV5.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GXC4X3TK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-VO6BVNHJ.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-JKTBX5CO.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-AY27X4XC.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-LHLWOUHO.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-WLR5DMCC.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-3MKPHMXQ.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-MNHQWR7N.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-EJNVUKSO.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-AN5AXNQF.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-MEK5JMSH.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-WSKISJ7T.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-7C5YQKED.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-EFHOKDY4.js");
      return {
  ...
  },
  {
    path: "me/sessions",
    lazy: async () => {
      const { SessionsPage } = await import("./SessionsPage-BQEUVNHF.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-GEGYJHAH.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-ZVZNOQM5.js");
          return {
  ...
  */
  createRouter(strapi, { memory, ...opts } = {}) {
    const authenticatedLayoutRoute = {
      path: "/*",
      lazy: async () => {
        const { PrivateAdminLayout } = await import("./AuthenticatedLayout-23X6UMQB.js");
        return {
  ...
  async register(customRegister) {
    const widgets = [
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-GE3H2EN7.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-GE3H2EN7.js");
    ...
    if ("strapi-cloud" in this.appPlugins) {
      widgets.push({
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-GE3H2EN7.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-KHRNFQWA.js");
...
//# sourceMappingURL=chunk-JBYTWJZI.js.map
