  ...
  if (isLoading) {
    return (0, import_jsx_runtime5.jsx)(_d.Content, {
      children: (0, import_jsx_runtime5.jsx)(_d.Body, {
        children: (0, import_jsx_runtime5.jsx)(v, {
...
var BulkActions = ({ selected = [], onSuccess, currentFolder }) => {
  ...
  return (0, import_jsx_runtime7.jsxs)(v, {
    gap: 2,
    paddingBottom: 5,
    children: [
...
var Header = ({ breadcrumbs = null, canCreate, folder = null, onToggleEditFolderDialog, onToggleUploadAssetDialog }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Layouts.Header, {
    ...
    primaryAction: canCreate && (0, import_jsx_runtime10.jsxs)(v, {
      gap: 2,
      width: "100%",
      children: [
...
// node_modules/@strapi/upload/dist/admin/pages/App/App.mjs
var ConfigureTheView = React6.lazy(async () => import("./ConfigureTheView-RXNIMZTA.js").then((mod) => ({
...
//# sourceMappingURL=App-MTRVNFYO.js.map
